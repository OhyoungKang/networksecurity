...
class DataTransformation:
    ...
    def initiate_data_transformation(self) -> DataTransformationArtifact:
        ...
        try:
            ...
            preporcessor_object = preprocessor.fit(input_feature_train_df)
            transformed_input_train_feature = preporcessor_object.transform(input_feature_train_df)
            transformed_input_test_feature = preporcessor_object.transform(input_feature_test_df)
            ...
            save_object(self.data_transformation_config.trasnformed_object_file_path, preporcessor_object)

            ## preparing artifacts
            data_transformation_artifact = DataTransformationArtifact(
                trasnformed_object_file_path=self.data_transformation_config.trasnformed_object_file_path,
